# `【开源不易、改造不易、哪(拿)来简单】如遇到问题，请先参见页面最后章节【常见问题】解决，如没有您的问题，请在页面最下面【撰写评论】。请【不要】在【问答】中提问，请【不要】在【问答】中提问，请【不要】在【问答】中提问（本账号不知为何无法登录问答了，不是不回答您的问题哦！）几星不重要，重要的是解决您的问题。再次感谢您的支持与鼓励！！`
...
# 修复堆叠图bug，修改柱状图tooltip效果，详见`堆叠图`图片
